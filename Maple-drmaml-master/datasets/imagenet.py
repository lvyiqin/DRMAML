...
class ImageNet(Dataset):
  def __init__(self, root_path, split='train', image_size=224,
    ...
    split_file = os.path.join(root_path, "ImageNet_category_split_"+split_tag + '.pt')
    # pdb.set_trace()
...
class MetaImageNet(ImageNet):
  def __init__(self, root_path, split='train', image_size=224,
    ...
    super(MetaImageNet, self).__init__(root_path, split, image_size,
